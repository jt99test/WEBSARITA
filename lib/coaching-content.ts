...
export const coachingContent: Record<Locale, CoachingContent> = {
  it: {
    ...
    astrologySite: {
      eyebrow: "Due modi per iniziare",
      title: "Con Sarita o con SaritaAstrology.com?",
      text:
        "I servizi in questa pagina sono sessioni personali con Sarita: più profondità, più dialogo e più adattamento alla tua situazione. SaritaAstrology.com è l'opzione più accessibile per ricevere una lettura online generata dal sito, utile se vuoi iniziare in modo semplice prima di prenotare un accompagnamento diretto.",
      directTitle: "Sessione personale",
      directValue: "Più personalizzata",
      websiteTitle: "Sito astrologico",
      websiteValue: "Più economico e immediato",
      cta: "Visita SaritaAstrology.com",
    },
  },
  es: {
    ...
    astrologySite: {
      ...
      title: "¿Con Sarita o con SaritaAstrology.com?",
      text:
        "Los servicios de esta página son sesiones personales con Sarita: más profundidad, más diálogo y más adaptación a tu situación. SaritaAstrology.com es la opción más accesible para recibir una lectura online generada por la web, útil si quieres empezar de forma sencilla antes de reservar un acompañamiento directo.",
      directTitle: "Sesión personal",
      directValue: "Más personalizada",
      websiteTitle: "Web astrológica",
      websiteValue: "Más económica e inmediata",
      cta: "Visitar SaritaAstrology.com",
    },
  },
  en: {
    ...
    astrologySite: {
      ...
      title: "With Sarita or with SaritaAstrology.com?",
      text:
        "The services on this page are personal sessions with Sarita: more depth, more dialogue, and more adaptation to your situation. SaritaAstrology.com is the more accessible option for an online reading generated by the website, useful if you want a simple first step before booking direct guidance.",
      directTitle: "Personal session",
      directValue: "More personalized",
      websiteTitle: "Astrology website",
      websiteValue: "Cheaper and immediate",
      cta: "Visit SaritaAstrology.com",
    },
  },
};
