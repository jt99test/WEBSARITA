...
export const coachingContent: Record<Locale, CoachingContent> = {
  it: {
    ...
    astrologySite: {
      ...
      directLabel: "Sessione personale: più personalizzata",
      websiteLabel: "Sito astrologico: più economico e immediato",
  ...
  es: {
    ...
    astrologySite: {
      ...
      directLabel: "Sesión personal: más personalizada",
      websiteLabel: "Web astrológica: más económica e inmediata",
  ...
  en: {
    ...
    astrologySite: {
      ...
      directLabel: "Personal session: more personalized",
      websiteLabel: "Astrology website: cheaper and immediate",
