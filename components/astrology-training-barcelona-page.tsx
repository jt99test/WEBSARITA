...
export function AstrologyTrainingBarcelonaPage({ locale }: { locale: Locale }) {
  const content = astrologyTrainingBarcelonaContent[locale];
      ...
      <section className="course-hero">
        <div className="course-hero-copy">
          ...
          <div className="hero-actions">
            <a className="primary-button" href={`mailto:${saritaContactEmail}`}>
              {content.primaryCta}
            </a>
      ...
      <section className="course-method-section">
        ...
        <aside className="panel course-contact-card">
          ...
          <div className="course-contact-links">
            <a href={`mailto:${saritaContactEmail}`}>{content.contact.emailLabel}</a>
